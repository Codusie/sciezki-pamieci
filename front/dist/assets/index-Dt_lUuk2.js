import{B as P,X as L,c as v,o as p,e as Y,m as s,aN as at,f as A,aO as k,U as q,aP as N,A as G,aQ as it,r as y,a as I,b as E,aR as dt,aS as ut,aT as J,aU as lt,ag as ct,t as tt,V as st,P as F,x as U,aV as H,L as bt,M as pt,aW as ft,W as gt,g as M,h as ht,j as yt,w as vt,n as R,d as mt}from"./index-Bn3QmsbV.js";import{s as D,B as nt,f as j}from"./index-CXLci-Lc.js";function kt(){let t=[],n=(a,d,u=999)=>{let c=r(a,d,u),f=c.value+(c.key===a?0:u)+1;return t.push({key:a,value:f}),f},o=a=>{t=t.filter(d=>d.value!==a)},e=(a,d)=>r(a).value,r=(a,d,u=0)=>[...t].reverse().find(c=>!0)||{key:a,value:u},i=a=>a&&parseInt(a.style.zIndex,10)||0;return{get:i,set:(a,d,u)=>{d&&(d.style.zIndex=String(n(a,!0,u)))},clear:a=>{a&&(o(i(a)),a.style.zIndex="")},getCurrent:a=>e(a)}}var An=kt(),wt=`
.p-icon {
...
`,Qt={root:function(n){var o=n.props,e=n.instance;return["p-badge p-component",{"p-badge-circle":G(o.value)&&String(o.value).length===1,"p-badge-dot":L(o.value)&&!e.$slots.default,"p-badge-sm":o.size==="small","p-badge-lg":o.size==="large","p-badge-xl":o.size==="xlarge","p-badge-info":o.severity==="info","p-badge-success":o.severity==="success","p-badge-warn":o.severity==="warn","p-badge-danger":o.severity==="danger","p-badge-secondary":o.severity==="secondary","p-badge-contrast":o.severity==="contrast"}]}},Xt=P.extend({name:"badge",style:Wt,classes:Qt}),Zt={name:"BaseBadge",extends:D,props:{value:{type:[String,Number],default:null},severity:{type:String,default:null},size:{type:String,default:null}},style:Xt,provide:function(){return{$pcBadge:this,$parentInstance:this}}};function $(t){"@babel/helpers - typeof";return $=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(n){return typeof n}:function(n){return n&&typeof Symbol=="function"&&n.constructor===Symbol&&n!==Symbol.prototype?"symbol":typeof n},$(t)}function X(t,n,o){return(n=Yt(n))in t?Object.defineProperty(t,n,{value:o,enumerable:!0,configurable:!0,writable:!0}):t[n]=o,t}function Yt(t){var n=qt(t,"string");return $(n)=="symbol"?n:n+""}function qt(t,n){if($(t)!="object"||!t)return t;var o=t[Symbol.toPrimitive];if(o!==void 0){var e=o.call(t,n);if($(e)!="object")return e;throw new TypeError("@@toPrimitive must return a primitive value.")}return(n==="string"?String:Number)(t)}var rt={name:"Badge",extends:Zt,inheritAttrs:!1,computed:{dataP:function(){return j(X(X({circle:this.value!=null&&String(this.value).length===1,empty:this.value==null&&!this.$slots.default},this.severity,this.severity),this.size,this.size))}}},Gt=["data-p"];function Jt(t,n,o,e,r,i){return p(),v("span",s({class:t.cx("root"),"data-p":i.dataP},t.ptmi("root")),[y(t.$slots,"default",{},function(){return[ct(tt(t.value),1)]})],16,Gt)}rt.render=Jt;var tn=`
    .p-ink {
        display: block;
        position: absolute;
